...
function Hero(){
    ...
    return(
        <div className="max-w-full  bg-center text-white mt-[5%]" id="home">
            <div className="bg-cover max-w-full h-[700px] mt-[-96px] w-full text-center flex flex-col justify-center"
